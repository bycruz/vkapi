...
local inputVertex = dirName .. "/shaders/voxel.vert.glsl"
local outputVertex = dirName .. "/shaders/voxel.vert.spv"
...
local inputFragment = dirName .. "/shaders/voxel.frag.glsl"
local outputFragment = dirName .. "/shaders/voxel.frag.spv"
